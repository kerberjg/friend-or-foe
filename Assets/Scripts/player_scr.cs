...
public class player_scr : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (curCharacter == Character.MOVING)
        {
            ...
            //    //Vector3 switchDirection = -transform.localPosition;
            ...
            //            transform.Translate(switchDirection.normalized * switchSpeed);
            //        else
            //        {
            //            transform.Translate(switchDirection);
        ...
        else if (curCharacter == Character.SEEING)
        {
            ...
            if (switchCharacter)
            {
                //Vector3 direction = new Vector3(-0.5f, 0.2f, 0.0f) - transform.localPosition;
                //Vector3 direction2 = -charactersTrans[2].localPosition;

                //if (transform.position.x < -0.51f ||
                //    transform.position.x > -0.49f ||
                //    transform.position.y < 0.19f ||
                //    transform.position.y > 0.21f)
                //{
                //    if (direction.magnitude > (direction.normalized * switchSpeed).magnitude)
                //        transform.Translate(direction.normalized * switchSpeed);
                //    else
                //    {
